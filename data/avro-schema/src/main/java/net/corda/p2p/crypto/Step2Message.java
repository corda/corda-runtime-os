...
public class Step2Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6532326929178652661L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Step2Message\",\"namespace\":\"net.corda.p2p.crypto\",\"fields\":[{\"name\":\"initiatorHello\",\"type\":{\"type\":\"record\",\"name\":\"InitiatorHelloMessage\",\"fields\":[{\"name\":\"header\",\"type\":{\"type\":\"record\",\"name\":\"CommonHeader\",\"fields\":[{\"name\":\"messageType\",\"type\":{\"type\":\"enum\",\"name\":\"MessageType\",\"symbols\":[\"INITIATOR_HELLO\",\"RESPONDER_HELLO\",\"INITIATOR_HANDSHAKE\",\"RESPONDER_HANDSHAKE\",\"DATA\"]}},{\"name\":\"protocolVersion\",\"type\":\"int\"},{\"name\":\"sessionId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"sequenceNo\",\"type\":\"long\"},{\"name\":\"timestamp\",\"type\":\"long\"}]}},{\"name\":\"initiatorPublicKey\",\"type\":\"bytes\"},{\"name\":\"supportedModes\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"enum\",\"name\":\"ProtocolMode\",\"symbols\":[\"AUTHENTICATION_ONLY\",\"AUTHENTICATED_ENCRYPTION\"]}}}]}},{\"name\":\"responderHello\",\"type\":{\"type\":\"record\",\"name\":\"ResponderHelloMessage\",\"fields\":[{\"name\":\"header\",\"type\":\"CommonHeader\"},{\"name\":\"responderPublicKey\",\"type\":\"bytes\"},{\"name\":\"selectedMode\",\"type\":\"ProtocolMode\"}]}},{\"name\":\"privateKey\",\"type\":\"bytes\"},{\"name\":\"publicKey\",\"type\":\"bytes\"}]}");
   ...
   */
  public Step2Message(net.corda.p2p.crypto.InitiatorHelloMessage initiatorHello, net.corda.p2p.crypto.ResponderHelloMessage responderHello, java.nio.ByteBuffer privateKey, java.nio.ByteBuffer publicKey) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: publicKey = (java.nio.ByteBuffer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static net.corda.p2p.crypto.Step2Message.Builder newBuilder() {
    return new net.corda.p2p.crypto.Step2Message.Builder();
  }
   ...
   * @return A new Step2Message RecordBuilder
   */
  public static net.corda.p2p.crypto.Step2Message.Builder newBuilder(net.corda.p2p.crypto.Step2Message.Builder other) {
    if (other == null) {
      return new net.corda.p2p.crypto.Step2Message.Builder();
    } else {
      return new net.corda.p2p.crypto.Step2Message.Builder(other);
    }
  }
   ...
   * @return A new Step2Message RecordBuilder
   */
  public static net.corda.p2p.crypto.Step2Message.Builder newBuilder(net.corda.p2p.crypto.Step2Message other) {
    if (other == null) {
      return new net.corda.p2p.crypto.Step2Message.Builder();
    } else {
      return new net.corda.p2p.crypto.Step2Message.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Step2Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.corda.p2p.crypto.Step2Message.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[3], other.publicKey)) {
        this.publicKey = data().deepCopy(fields()[3].schema(), other.publicKey);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.corda.p2p.crypto.Step2Message other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.initiatorHello)) {
        this.initiatorHello = data().deepCopy(fields()[0].schema(), other.initiatorHello);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.p2p.crypto.Step2Message.Builder setInitiatorHello(net.corda.p2p.crypto.InitiatorHelloMessage value) {
    ...
    public net.corda.p2p.crypto.Step2Message.Builder setInitiatorHelloBuilder(net.corda.p2p.crypto.InitiatorHelloMessage.Builder value) {
      clearInitiatorHello();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.p2p.crypto.Step2Message.Builder clearInitiatorHello() {
      initiatorHello = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.p2p.crypto.Step2Message.Builder setResponderHello(net.corda.p2p.crypto.ResponderHelloMessage value) {
    ...
    public net.corda.p2p.crypto.Step2Message.Builder setResponderHelloBuilder(net.corda.p2p.crypto.ResponderHelloMessage.Builder value) {
      clearResponderHello();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.p2p.crypto.Step2Message.Builder clearResponderHello() {
      responderHello = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.p2p.crypto.Step2Message.Builder setPrivateKey(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.p2p.crypto.Step2Message.Builder clearPrivateKey() {
      privateKey = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.p2p.crypto.Step2Message.Builder setPublicKey(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.p2p.crypto.Step2Message.Builder clearPublicKey() {
      publicKey = null;
    ...
    public Step2Message build() {
      try {
        ...
        record.publicKey = fieldSetFlags()[3] ? this.publicKey : (java.nio.ByteBuffer) defaultValue(fields()[3]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.publicKey = in.readBytes(this.publicKey);
