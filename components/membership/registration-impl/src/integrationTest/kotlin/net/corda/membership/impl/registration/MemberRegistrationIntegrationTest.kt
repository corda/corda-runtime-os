...
class MemberRegistrationIntegrationTest {
    private companion object {
        ...
        fun setUp() {
            ...
            keyValuePairListDeserializer = serializationFactory.createAvroDeserializer({ _, _ -> }, KeyValuePairList::class.java,)
            requestDeserializer =
                serializationFactory.createAvroDeserializer({ _, _ -> }, MembershipRegistrationRequest::class.java,)
            unauthRequestDeserializer =
                serializationFactory.createAvroDeserializer({ _, _ ->}, UnauthenticatedRegistrationRequest::class.java,)
