...
class UtxoReceiveFinalityFlowV1Test {
    ...
    private val currentGroupParametersService = mock<GroupParametersServiceInternal>()
    ...
    fun beforeEach() {
        ...
        whenever(currentGroupParametersService.groupParameters).thenReturn(currentGroupParameters)
