...
interface KeysRestResource : RestResource {
     ...
     * services, or the value 'rpc-api' for a cluster-level tenant of the RPC API.
    ...
    fun listSchemes(
        @RestPathParameter(description = "Can either be a holding identity ID, the value 'p2p' for a cluster-level" +
                " tenant of the P2P services, or the value 'rpc-api' for a cluster-level tenant of the RPC API")
        tenantId: String,
