 ...
 */
internal class IsolatingResolverBundleHook(private val sandboxService: SandboxServiceInternal) : ResolverHook {
...
internal class IsolatingResolverBundleHookFactory @Activate constructor(
        @Reference
        private val sandboxManagerService: SandboxServiceInternal) : ResolverHookFactory {
