...
fun mockCurrentGroupParametersService(): CurrentGroupParametersServiceInternal {

    val mockCurrentGroupParametersService = Mockito.mock(CurrentGroupParametersServiceInternal::class.java)
    ...
    Mockito.`when`(mockCurrentGroupParametersService.currentGroupParameters).thenReturn(mockSignedGroupParameters)
