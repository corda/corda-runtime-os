...
open class SandboxDependencyInjectorImpl(
    singletons: Map<SingletonSerializeAsToken, List<String>>,
    private val closeable: AutoCloseable
) : SandboxDependencyInjector {
    val serviceTypeMap: Map<Class<*>, SingletonSerializeAsToken>
    ...
    init {
        ...
        serviceTypeMap = Collections.unmodifiableMap(serviceTypes)
    }
     ...
     */
    fun Class<*>.getFieldsForInjection(): Collection<Field> {
