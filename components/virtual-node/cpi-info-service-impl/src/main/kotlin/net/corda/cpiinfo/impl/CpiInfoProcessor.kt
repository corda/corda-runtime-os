 ...
 */
class CpiInfoProcessor(private val onStatusUpCallback: () -> Unit, private val onErrorCallback: () -> Unit) :
    CpiInfoService,
    AutoCloseable,
     ...
     */
    private class ListenerSubscription(private val service: CpiInfoProcessor) : AutoCloseable {
        override fun close() {
