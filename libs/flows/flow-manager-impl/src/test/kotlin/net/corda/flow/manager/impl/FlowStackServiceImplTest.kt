...
class FlowStackServiceImplTest {
    ...
    fun `push creates and initializes stack item`() {
        ...
        assertThat(flowStackItem1.flowName).isEqualTo("net.corda.flow.manager.impl.InitiatingFlowExample")
        assertThat(flowStackItem1.isInitiatingFlow).isTrue
        assertThat(flowStackItem1.sessionIds).isEmpty()

        assertThat(flowStackItem2.flowName).isEqualTo("net.corda.flow.manager.impl.NonInitiatingFlowExample")
