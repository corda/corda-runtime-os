...
/**
 *
 * TEMPORARY STUB CLASSES TO BE REPLACED WITH ACTUAL IMPLEMENTATIONS AFTER REBASE
 *
 */
...
class GroupParametersFactoryImpl(
    private val layeredPropertyMapFactory: LayeredPropertyMapFactory
) : GroupParametersFactory {

    override fun create(groupParameters: Map<String, String?>): GroupParameters {
        return layeredPropertyMapFactory.create<GroupParametersImpl>(groupParameters)
    }

    private class GroupParametersImpl(
