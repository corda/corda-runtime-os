...
class DevCryptoServiceProviderTests {
    ...
    private fun createCryptoServiceProvider(): DevCryptoServiceProviderImpl {
        return DevCryptoServiceProviderImpl().also {
    ...
    private fun DevCryptoServiceProviderImpl.createCryptoService(category: String): CryptoService = getInstance(
