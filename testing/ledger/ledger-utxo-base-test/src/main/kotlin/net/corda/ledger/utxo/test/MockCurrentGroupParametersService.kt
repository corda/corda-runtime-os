...
fun mockCurrentGroupParametersService(): GroupParametersServiceInternal {

    val mockCurrentGroupParametersService = Mockito.mock(GroupParametersServiceInternal::class.java)
    ...
    Mockito.`when`(mockCurrentGroupParametersService.groupParameters).thenReturn(mockSignedGroupParameters)
