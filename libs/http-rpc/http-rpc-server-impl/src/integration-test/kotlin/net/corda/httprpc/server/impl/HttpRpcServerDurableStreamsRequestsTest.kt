...
import net.corda.httprpc.server.impl.rpcops.impl.NumberSequencesControllerImpl
...
class HttpRpcServerDurableStreamsRequestsTest {
    ...
    companion object {
        ...
        fun setUpBeforeClass() {
            ...
            HttpRpcServerTestBase.server = HttpRpcServerImpl(
                listOf(
                    NumberSequencesControllerImpl(),
                    CalendarControllerImpl(),
                    TestHealthCheckControllerImpl(),
                    CustomSerializationControllerImpl()
                ), HttpRpcServerTestBase.securityManager, httpRpcSettings, true
            ).apply { start() }
            HttpRpcServerTestBase.client =
    ...
    fun `POST to numberseq_retrieve should return correct values`() {
        ...
        val response = HttpRpcServerTestBase.client.call(
            HttpVerb.POST,
            WebRequest<Any>("numberseq/retrieve", requestBody),
            HttpRpcServerTestBase.userName,
            HttpRpcServerTestBase.password
        )
    ...
    fun `POST to numberseq_retrieve with updated position should return correct values`() {
        ...
        val responseBodyNewPosition = """{
            ...
            |"remainingElementsCountEstimate":9223372036854775807
            |}""".compact()
        val secondResponse = HttpRpcServerTestBase.client.call(
            HttpVerb.POST,
