...
interface FlowFiberCache : SandboxedCache {
     ...
     */
    fun put(key: FlowKey, suspendCount: Int, fiber: FlowFiber, sessions: List<SessionState>)

    /**
     * Get a flow fiber from the cache with the given [FlowKey], [suspendCount] and [sandboxGroupId], or else return null.
     */
    fun get(key: FlowKey, suspendCount: Int, sandboxGroupId: UUID, sessions: List<SessionState>): FlowFiber?
