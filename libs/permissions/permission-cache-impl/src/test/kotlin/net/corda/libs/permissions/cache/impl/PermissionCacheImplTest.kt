...
internal class PermissionCacheImplTest {
    ...
    private val role1 = Role("role1", 0, ChangeDetails(Instant.now(), "changeUser"), "admin", listOf(permission1))
    private val role2 = Role("role2", 0, ChangeDetails(Instant.now(), "changeUser"), "admin", listOf(permission2))
