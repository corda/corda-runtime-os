...
internal class InboundMessageProcessor(
    ...
    override fun onNext(events: List<EventLogRecord<String, LinkInMessage>>): List<Record<*, *>> {
        return handleRequests(
            ...
            traceEventProcessing(traceable.source.record, tracingEventName) { traceable.item.records }
    ...
    internal fun <T: InboundMessage> handleRequests(
        ...
        return processSessionMessages(sessionMessages) + recordsForUnauthenticatedMessage + processDataMessages(dataMessages)
    }
