...
internal class FlowExecutionPipelineStage(
    ...
    private fun executeFlow(
        ...
        MediatorTraceLog.recordEvent(context.inputEvent.flowId, "Flow fiber started in the background.")
        val fiberResult = try {
            ...
            MediatorTraceLog.recordEvent(context.inputEvent.flowId, "Flow fiber exited with error.")
        ...
        MediatorTraceLog.recordEvent(context.inputEvent.flowId, "Flow fiber exited.")
