...
interface TransactionService : TransactionStorage, TransactionMappingService, TransactionVerificationService,
    ...
    /**
     * Creates an additional signature for an existing (partially) [SignedTransaction]. Additional [SignatureMetadata], including the
     ...
     * a [CompositeKey] the first leaf key found locally will be used for signing.
     *
     * @return The [DigitalSignatureAndMeta] generated by signing with the internally held [PrivateKey].
     */
    fun createSignature(signedTransaction: SignedTransaction, publicKey: PublicKey): DigitalSignatureAndMeta
     ...
     * identity key is used to sign. Additional [SignatureMetadata], including the platform version used during signing and the
     * cryptographic signature scheme use, is added to the signature.
     *
     * @param signedTransaction The [SignedTransaction] to which the signature will apply.
     *
     * @return The [DigitalSignatureAndMeta] generated by signing with the internally held identity PrivateKey.
     */
    fun createSignature(signedTransaction: SignedTransaction): DigitalSignatureAndMeta

    /**
     * Creates a signature for a FilteredTransaction. Additional [SignatureMetadata], including the platform version used during signing and
     ...
     * a [CompositeKey], the first leaf key found locally will be used for signing.
     *
     * @return The [DigitalSignatureAndMeta] generated by signing with the internally held [java.security.PrivateKey].
     */
    fun createSignature(filteredTransaction: FilteredTransaction, publicKey: PublicKey): DigitalSignatureAndMeta
     ...
     * sign. Additional [SignatureMetadata], including the platform version used during signing and the cryptographic signature scheme use,
     ...
     * @return The [DigitalSignatureAndMeta] generated by signing with the internally held identity [PrivateKey].
     */
    fun createSignature(filteredTransaction: FilteredTransaction): DigitalSignatureAndMeta
