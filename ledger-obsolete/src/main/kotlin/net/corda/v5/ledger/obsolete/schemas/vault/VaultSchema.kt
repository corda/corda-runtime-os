package net.corda.v5.ledger.obsolete.schemas.vault
...
import net.corda.v5.ledger.obsolete.schemas.PersistentStateRef
...
object VaultSchemaV1 : MappedSchema(
    ...
    /**
     *  Constraint information associated with a [net.corda.v5.ledger.obsolete.contracts.ContractState].
     *  See [CPKConstraint]
     */
    @CordaSerializable
    ...
    class VaultState(
        ...
        /** references a concrete ContractState that is [net.corda.v5.ledger.obsolete.schemas.QueryableState] and has a [MappedSchema] */
    ...
    class VaultLinearState(
        /** [net.corda.v5.ledger.obsolete.contracts.ContractState] attributes */

        /**
         *  Represents a [net.corda.v5.ledger.obsolete.contracts.LinearState] [UniqueIdentifier]
         */
    ...
    class VaultFungibleState(
        /** [net.corda.v5.ledger.obsolete.contracts.FungibleState] attributes
         *
