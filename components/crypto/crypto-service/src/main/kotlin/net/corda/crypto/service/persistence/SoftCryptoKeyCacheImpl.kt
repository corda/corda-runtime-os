...
class SoftCryptoKeyCacheImpl(
    ...
    val persistence: KeyValuePersistence<SoftKeysRecordInfo, SoftKeysRecord> =
    ...
    override fun find(alias: String): SoftKeysRecordInfo? {
    ...
    private fun mutate(entity: SoftKeysRecord): SoftKeysRecordInfo =
