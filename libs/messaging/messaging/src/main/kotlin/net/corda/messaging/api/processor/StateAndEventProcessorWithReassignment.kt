...
interface StateAndEventProcessorWithReassignment<K : Any, S : Any, E : Any> {
    ...
    fun onPartitionsRevoked(states: Map<K, S>)

    fun onPartitionsAssigned(states: Map<K, S>)
