...
public class JavaPrivatePropertyTests {
    ...
    public void singlePrivateBooleanWithConstructor() throws NotSerializableException {
        ...
        B b = new B(true);
        B b2 = des.deserialize(new OpaqueBytes(ser.serialize(b, TestSerializationContext.testSerializationContext).getBytes()), B.class, TestSerializationContext.testSerializationContext);
    ...
    public void singlePrivateBooleanWithNoConstructor() throws NotSerializableException {
        ...
        B2 b = new B2();
        b.setB(false);
        B2 b2 = des.deserialize(new OpaqueBytes(ser.serialize(b, TestSerializationContext.testSerializationContext).getBytes()), B2.class, TestSerializationContext.testSerializationContext);
        assertEquals (b.b, b2.b);
    }
    ...
    public void testCapitilsationOfIs() throws NotSerializableException {
        ...
        B3 b = new B3();
        b.setB(false);
        B3 b2 = des.deserialize(new OpaqueBytes(ser.serialize(b, TestSerializationContext.testSerializationContext).getBytes()), B3.class, TestSerializationContext.testSerializationContext);
    ...
    public void singlePrivateIntWithBoolean() throws NotSerializableException {
        ...
        C3 c = new C3();
        c.setA(12345);
        C3 c2 = des.deserialize(new OpaqueBytes(ser.serialize(c, TestSerializationContext.testSerializationContext).getBytes()), C3.class, TestSerializationContext.testSerializationContext);
    ...
    public void singlePrivateWithConstructor() throws NotSerializableException {
        ...
        C c2 = des.deserialize(new OpaqueBytes(ser.serialize(c, TestSerializationContext.testSerializationContext).getBytes()), C.class, TestSerializationContext.testSerializationContext);
    ...
    public void singlePrivateWithConstructorAndGetter()
        ...
        C2 c2 = des.deserialize(new OpaqueBytes(ser.serialize(c, TestSerializationContext.testSerializationContext).getBytes()), C2.class, TestSerializationContext.testSerializationContext);
