...
class SessionEventHandler @Activate constructor(
    ...
    private fun createCheckpointIfDoesNotExist(
        ...
        if (!checkpoint.doesExist) {
            ...
            if (sessionInit == null) {
                ...
                val isInteropSession = sessionEvent.contextSessionProperties.toMap()[FLOW_SESSION_IS_INTEROP]?.equals("true") ?: false
                createInitiatedFlowCheckpoint(context, sessionInit.cpiId, sessionEvent, isInteropSession)
            }
        }
    }
    ...
    private fun createInitiatedFlowCheckpoint(
        ...
        val initiatedFlowNameAndProtocolResult = initializeCheckpointAndGetResult(
            context, sessionEvent, isInteropSession, cpiId, requestedProtocolName, initiatorVersionsSupported
        )
    ...
    private fun initializeCheckpointAndGetResult(
        ...
        checkpointInitializer.initialize(
            ...
            initiatedFlowNameAndProtocolResult = if (!isInteropSession) {
            ...
            FlowStartContext.newBuilder()
                ...
                .setInitiatorType(if (isInteropSession) FlowInitiatorType.INTEROP else FlowInitiatorType.P2P)
