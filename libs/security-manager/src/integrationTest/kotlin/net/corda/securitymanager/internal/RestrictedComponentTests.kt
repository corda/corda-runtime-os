...
class RestrictedComponentTests {
    ...
    fun testWeCannotResolveScrReferenceWithoutPermission() {
        securityManagerService.denyPermissions(cpkBundle.location, setOf(scrPermission))
        cpkBundle.start()
    ...
    fun testWeCanResolveScrReferenceWithPermission() {
        securityManagerService.grantPermissions(cpkBundle.location, setOf(scrPermission))
        cpkBundle.start()
