...
class CreateLockFlow : ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        ...
        try {
            ...
            val unconsumedStates = ledgerService.findUnconsumedStatesByExactType(Asset::class.java, 10, Instant.now())
            val unconsumedStatesWithId = unconsumedStates.results.filter { it.state.contractState.assetId == stateId }
