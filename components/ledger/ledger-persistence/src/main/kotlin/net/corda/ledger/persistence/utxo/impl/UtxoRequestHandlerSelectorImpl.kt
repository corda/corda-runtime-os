...
import net.corda.ledger.persistence.utxo.impl.request.handlers.UtxoIncrementTransactionRecoveryAttemptCountRequestHandler
...
class UtxoRequestHandlerSelectorImpl @Activate constructor(
    ...
    override fun selectHandler(sandbox: SandboxGroupContext, request: LedgerPersistenceRequest): RequestHandler {
        ...
        return when (val req = request.request) {
            ...
            is IncrementTransactionRecoveryAttemptCount -> {
                UtxoIncrementTransactionRecoveryAttemptCountRequestHandler(
                    req,
                    externalEventContext,
                    persistenceService,
                    externalEventResponseFactory
