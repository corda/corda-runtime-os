...
//        val configWriterFactory = RPCSubscriptionFactory(getSubscriptionFactory(), getPublisherFactory(), getConfigValidatorFactory(), mock())
...
//        val configWriterFactory = RPCSubscriptionFactory(getSubscriptionFactory(), publisherFactory, getConfigValidatorFactory(), mock())
...
//        val configWriterFactory = RPCSubscriptionFactory(subscriptionFactory, getPublisherFactory(), getConfigValidatorFactory(), mock())
//        configWriterFactory.create(expectedConfig)
//
