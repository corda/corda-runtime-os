 ...
 *
 * In relation to multi-threaded aspect of this interface:
 * Since it is really the caller of the [DurableCursor.poll] and [DurableCursor.commit] who controls the thread which will
 * used for [PositionManager] invocations, there are no special provisions made to ensure thread safety of the invocation to this interface.
 * The key principle here is that: Whichever position committed by calling [PositionManager.accept] should be available when [PositionManager.get]
 * is called.
 */
