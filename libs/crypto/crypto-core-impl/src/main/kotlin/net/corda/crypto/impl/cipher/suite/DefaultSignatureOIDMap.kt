...
object DefaultSignatureOIDMap {
    ...
    fun inferSignatureOID(publicKey: PublicKey, signatureSpec: SignatureSpec): AlgorithmIdentifier? {
        ...
        return if (EDDSA_ED25519.algorithmOIDs.contains(algorithm)) {
            if (signatureSpec.equal(SignatureSpec.EDDSA_ED25519)) {
                AlgorithmIdentifier(ID_CURVE_25519PH, null)
            } else {
                null
            }
        } else if (SPHINCS256.algorithmOIDs.contains(algorithm)) {
            if (signatureSpec.equal(SignatureSpec.SPHINCS256_SHA512)) {
                SPHINCS256_SHA512
            } else {
                null
            }
        } else if (SM2.algorithmOIDs.contains(algorithm)) {
            when {
                signatureSpec.equal(SignatureSpec.SM2_SM3) -> SM3_SM2
                else -> null
            }
        } else if (GOST3410_GOST3411.algorithmOIDs.contains(algorithm)) {
        ...
        } else if (ECDSA_SECP256R1.algorithmOIDs.contains(algorithm)) {
            when {
        ...
        } else if (ECDSA_SECP256K1.algorithmOIDs.contains(algorithm)) {
            when {
        ...
        } else if (RSA.algorithmOIDs.contains(algorithm)) {
