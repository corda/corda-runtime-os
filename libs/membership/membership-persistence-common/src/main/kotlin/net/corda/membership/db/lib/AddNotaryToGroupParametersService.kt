...
class AddNotaryToGroupParametersService(
    clock: Clock,
    ...
    private companion object {
        val notaryServiceRegex = GroupParametersNotaryUpdater.NOTARY_SERVICE_NAME_KEY.format("([0-9]+)").toRegex()
        val logger = LoggerFactory.getLogger(AddNotaryToGroupParametersService::class.java)
    }
