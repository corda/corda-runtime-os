...
//    }
    ...
    fun `test throwables serialize`() {
        val factory = SerializerFactoryBuilder.build(AllWhitelist)
        factory.register(net.corda.internal.serialization.amqp.custom.ThrowableSerializer(factory))

        val factory2 = SerializerFactoryBuilder.build(AllWhitelist)
        factory2.register(net.corda.internal.serialization.amqp.custom.ThrowableSerializer(factory2))
    ...
    fun `test local time serialize`() {
        ...
        val factory2 = SerializerFactoryBuilder.build(AllWhitelist)
        factory2.register(net.corda.internal.serialization.amqp.custom.LocalTimeSerializer(factory2))
    ...
    fun `test local date time serialize`() {
        val factory = SerializerFactoryBuilder.build(AllWhitelist)
        factory.register(net.corda.internal.serialization.amqp.custom.LocalDateTimeSerializer(factory))

        val factory2 = SerializerFactoryBuilder.build(AllWhitelist)
        factory2.register(net.corda.internal.serialization.amqp.custom.LocalDateTimeSerializer(factory2))
    ...
    fun `test zoned date time serialize`() {
        val factory = SerializerFactoryBuilder.build(AllWhitelist)
        factory.register(net.corda.internal.serialization.amqp.custom.ZonedDateTimeSerializer(factory))

        val factory2 = SerializerFactoryBuilder.build(AllWhitelist)
        factory2.register(net.corda.internal.serialization.amqp.custom.ZonedDateTimeSerializer(factory2))
    ...
    fun `test offset date time serialize`() {
        ...
        val factory2 = SerializerFactoryBuilder.build(AllWhitelist)
        factory2.register(net.corda.internal.serialization.amqp.custom.OffsetDateTimeSerializer(factory2))
    ...
    fun `test year serialize`() {
        val factory = SerializerFactoryBuilder.build(AllWhitelist)
        factory.register(net.corda.internal.serialization.amqp.custom.YearSerializer(factory))

        val factory2 = SerializerFactoryBuilder.build(AllWhitelist)
        factory2.register(net.corda.internal.serialization.amqp.custom.YearSerializer(factory2))
    ...
    fun `test year month serialize`() {
        val factory = SerializerFactoryBuilder.build(AllWhitelist)
        factory.register(net.corda.internal.serialization.amqp.custom.YearMonthSerializer(factory))

        val factory2 = SerializerFactoryBuilder.build(AllWhitelist)
        factory2.register(net.corda.internal.serialization.amqp.custom.YearMonthSerializer(factory2))
    ...
    fun `test period serialize`() {
        ...
        val factory2 = SerializerFactoryBuilder.build(AllWhitelist)
        factory2.register(net.corda.internal.serialization.amqp.custom.PeriodSerializer(factory2))
...
//    }
    ...
    fun `test InputStream serialize`() {
        val factory = SerializerFactoryBuilder.build(AllWhitelist)
        factory.register(net.corda.internal.serialization.amqp.custom.InputStreamSerializer)

        val factory2 = SerializerFactoryBuilder.build(AllWhitelist)
        factory2.register(net.corda.internal.serialization.amqp.custom.InputStreamSerializer)
