...
class TopicServiceImplTest {
    ...
    fun testGetRecordsWhenNotSubscribed() {
        assertThrows<CordaMessageAPIFatalException> { topicService.getRecords("", "", 100) }
    }

    @Test
    fun testCommitOffsetWhenNoTopic() {
        assertThrows<CordaMessageAPIFatalException> { topicService.commitOffset("", "", 1) }
    }
