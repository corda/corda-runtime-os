...
/**
 * This annotation is used to mark a class as having had a property element. It is used by the
...
public @interface CordaSerializationTransformRename {
    ...
    /**
     * from
     * @return {@link String} representation of the properties old name.
     */
    String from();
}
