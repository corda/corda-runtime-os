...
class KeysRestResourceImpl @Activate constructor(
    ...
    override fun listSchemes(
        ...
        logger.warn("Deprecated, please use next version at /key/{tenantId}/schemes/{hsmCategory}")

        return tryWithExceptionHandling(logger, "list supported schemes for tenant $tenantId") {
    ...
    override fun listKeys(
        ...
        logger.warn("Deprecated, please use next version at /key/{tenantId}")
    ...
    override fun generateKeyPair(
        ...
        logger.warn("Deprecated, please use next version at /key/{tenantId}/alias/{alias}/category/{hsmCategory}/scheme/{scheme}")
    ...
    override fun generateKeyPem(
        ...
        logger.warn("Deprecated, please use next version at /key/{tenantId}/{keyId}")
