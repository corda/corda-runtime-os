...
class MGMRpcOpsImpl @Activate constructor(
    ...
    private interface InnerMGMRpcOps {
        fun getGroupPolicy(holdingIdentityId: String): RegistrationRequestProgress
    }
    ...
    private inner class ActiveImpl : InnerMGMRpcOps {
        override fun getGroupPolicy(holdingIdentityId: String): RegistrationRequestProgress {
            return mgmOpsClient.getGroupPolicy(holdingIdentityId).fromDto()
        }
    }
}