...
import net.corda.v5.ledger.obsolete.transactions.requireNotNullContractClassName
import net.corda.v5.ledger.obsolete.transactions.requiredContractClassName
...
data class StateAndRef<out T : ContractState>(val state: TransactionState<T>, val ref: StateRef) {
    /** For adding [StateAndRef]s as references to a [TransactionBuilder][net.corda.v5.ledger.obsolete.transactions.TransactionBuilder]. */
