...
@Component(service = [FlowClassRpcOps::class, PluggableRPCOps::class], immediate = true)
class FlowClassRPCOpsImpl @Activate constructor(
...
) : FlowClassRpcOps, PluggableRPCOps<FlowClassRpcOps>, Lifecycle {
    ...
    override val targetInterface: Class<FlowClassRpcOps> = FlowClassRpcOps::class.java
    override val protocolVersion: Int = 1

    private val coordinator = lifecycleCoordinatorFactory.createCoordinator<FlowClassRpcOps>(::eventHandler)
    ...
    override fun getStartableFlows(holderShortId: String): StartableFlowsResponse {
