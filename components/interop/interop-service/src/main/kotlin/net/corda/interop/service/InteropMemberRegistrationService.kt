...
class InteropMemberRegistrationService {
    ...
    companion object {
        ...
        private val memberList =
            listOf(HoldingIdentity(ALICE_X500_NAME, "group1"), HoldingIdentity(ALICE_ALTER_EGO_X500_NAME, "group1"))
    }
    ...
    fun createDummyMemberInfo(): List<Record<String, PersistentMemberInfo>> {
        ...
        val memberContext = listOf(
            ...
            KeyValuePair(
                ...
                "T2UUKZGNpG8StV8bQ8YSFHLsyosdULMNI0r68l3k2Q6pKmpu91Jg==\\n-----END PUBLIC KEY-----\\n"
            ),
            ...
            KeyValuePair(
                ...
                "0gz23IlZNTfBDWHRthwth/I2PKqiHTrRHZh3L6k41Sb2A/1TjX5A==\\n-----END PUBLIC KEY-----\\n"
            ),
            KeyValuePair(
