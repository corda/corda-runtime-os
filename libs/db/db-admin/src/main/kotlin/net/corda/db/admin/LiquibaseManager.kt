...
interface LiquibaseManager {
     ...
     * @param sql An optional writer to output the sql into.
     * Note: that if non-null value is passed the Liquibase transform is not actually performed,
     * but intended DB changes are sent to the writer.
