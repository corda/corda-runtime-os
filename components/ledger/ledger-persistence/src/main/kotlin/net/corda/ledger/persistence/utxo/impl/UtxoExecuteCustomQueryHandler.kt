...
class UtxoExecuteCustomQueryHandler(
    ...
    private companion object {
        val log = LoggerFactory.getLogger(UtxoExecuteCustomQueryHandler::class.java)
    }

    override fun execute(): List<Record<*, *>> {

        log.info("UtxoExecuteCustomQueryHandler executing")

        return try {
            val resultSet = vaultNamedQueryExecutor.executeQuery(holdingIdentity, request)
