...
//    }
//
//    override fun createLock(denomination: String, amount: BigDecimal, otherParty: String, notaryKeys: ByteBuffer, draft: String): String {
//        return "not-a-random-string"
//    }
//
//    @Suspendable
//    override fun unlock(reservationRef: String, proof: DigitalSignatureAndMetadata): BigDecimal {
