...
//
//        val digitalSignatureWithKey = DigitalSignatureWithKey(publicKeyExample, signatory)
//        val signatureSpec = RSA_SHA256
//        val groupParameters = groupParametersFactory.create(byteArrayOf(0x01), digitalSignatureWithKey, signatureSpec)
//
//        return UtxoLedgerTransactionContainer(wireTransaction, inputStateAndRefs, referenceStateAndRefs, groupParameters)
//    }
//
...
//    )
//
////    private fun SignedGroupParameters.toCorda() = mgmSignature?.let { signature ->
