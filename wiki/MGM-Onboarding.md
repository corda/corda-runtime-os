...
$MGM_HOLDING_ID = $VIRTUAL_NODE_RESPONSE.requestId
```
</details>
...
To make changes to the group parameters, see [Group Parameters Update](https://github.com/corda/corda-runtime-os/wiki/Group-Parameters-Update).
