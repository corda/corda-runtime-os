...
import net.corda.components.examples.stateevent.processor.ChaosTestStringsStateAndEventProcessor
...
@Component
class RunChaosTestStringsStateEventSub(
    ...
    private var subscription: StateAndEventSubscription<String, String, String>? = null
    ...
    override fun start() {
        if (!isRunning) {
            ...
            val processor = ChaosTestStringsStateAndEventProcessor(killProcessOnRecord, delayOnNext)
