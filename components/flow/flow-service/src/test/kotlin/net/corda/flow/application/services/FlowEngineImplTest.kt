...
class FlowEngineImplTest {
    ...
    private val errorSessionState =
        SessionState("s", mock(), mock(), null, false, null, null, null, SessionStateType.ERROR, false, null)
    private val closedSessionState =
        SessionState("s", mock(), mock(), null, false, null, null, null, SessionStateType.CLOSED, false, null)
