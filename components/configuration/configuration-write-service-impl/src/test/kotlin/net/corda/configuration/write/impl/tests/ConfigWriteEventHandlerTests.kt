...
//    /** Returns a mock [ConfigWriter] and a mock [RPCSubscriptionFactory] that returns it. */
//    private fun getConfigWriterAndFactory(): Pair<ConfigWriter, RPCSubscriptionFactory> {
//        val configWriter = mock<ConfigWriter>()
//        return configWriter to mock<RPCSubscriptionFactory>().apply {
...
//        val erroringConfigWriterFactory = mock<RPCSubscriptionFactory>().apply {
...
//        }
//        val configWriterFactory = mock<RPCSubscriptionFactory>().apply {
