 ...
 *
 * @property maxRetries The maximum number of a times a retry will be attempted. Default is 3
...
data class HTTPRetryConfig(
    ...
    class Builder {
        ...
        fun maxRetries(maxRetryCount: Int) = apply { this.maxRetries = maxRetryCount }
        ...
        fun build(): HTTPRetryConfig {
            return HTTPRetryConfig(maxRetries, initialDelay, factor, retryOn)
        }
    }
}
