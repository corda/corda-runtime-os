...
class CordaMetricsTest {
    ...
    fun `gauge with computed values`() {
        ...
        val gauge = CordaMetrics.Metric.CachedSessionCount(items::size).builder().build()
        ...
        val gaugeId = CordaMetrics.Metric.CachedSessionCount { Double.NaN }.builder().buildPreFilterId()
    ...
    fun `gauges with tags`() {
        ...
        val thingsGauge = CordaMetrics.Metric.CachedSessionCount(things::size).builder()
            .withTag(MembershipGroup, "things")
            .build()

        val stuff = mutableListOf<String>()
        val stuffGauge = CordaMetrics.Metric.CachedSessionCount(stuff::size).builder()
        ...
        val thingsGaugeId = CordaMetrics.Metric.CachedSessionCount { Double.NaN }.builder()
            .withTag(MembershipGroup, "things")
            .buildPreFilterId()
