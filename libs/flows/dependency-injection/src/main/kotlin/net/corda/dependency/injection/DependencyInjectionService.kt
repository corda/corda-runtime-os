...
interface DependencyInjectionService {
     ...
     *
     * @param injectableInterface The interface for which the implementation injector will build an implementation for.
...
/**
 * Interface which is used to build dynamic injectables for the dependency injection logic.
