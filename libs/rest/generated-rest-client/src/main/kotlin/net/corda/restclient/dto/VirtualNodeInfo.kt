...
/**
 * Virtual Node Info - This is a duplicate of [net.corda.libs.virtualnode.endpoints.v1.types.VirtualNodeInfo]
 * Because we need to use the custom [RouteConfiguration] type
 *
