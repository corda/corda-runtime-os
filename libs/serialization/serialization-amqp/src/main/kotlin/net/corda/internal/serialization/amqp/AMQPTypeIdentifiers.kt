    ...
    private val primitiveTypeNamesByName = sequenceOf(
        ...
        .flatMap { (klass, name) ->
            ...
            if (primitiveTypeIdentifier == null) {
                sequenceOf(typeIdentifier to name)
            } else {
                sequenceOf(typeIdentifier to name, primitiveTypeIdentifier to name)
            }
        }.toMap()
