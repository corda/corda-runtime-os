...
class UnsignedGroupParametersImplTest {
    ...
    @Test
    fun `group parameters with the same serialised parameters are equal`() {
    ...
    fun `group parameters with different serialised parameters are not equal`() {
        val firstParams = createTestParams()
        val secondParams = createTestParams("other-params".toByteArray())
