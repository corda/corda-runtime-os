...
class P2pEndpointVerifierTest {
    ...
    fun `context with no URL will throw an exception`() {
        ...
        assertThatThrownBy {
         ...
         .hasMessageContaining("No path URL was provided.")
    }
    ...
    fun `context with no protocol version will throw an exception`() {
        ...
        assertThatThrownBy {
         ...
         .hasMessageContaining("No path protocol was provided.")
    }
    ...
    fun `context with out of order URLs will throw an exception`() {
        ...
        assertThatThrownBy {
         ...
         .hasMessageContaining("Provided path URLs are incorrectly numbered.")
    }
    ...
    fun `context with out of order protocol version will throw an exception`() {
        ...
        assertThatThrownBy {
         ...
         .hasMessageContaining("Provided path protocols are incorrectly numbered.")
    }
    ...
    fun `context with URL without a port will throw an exception`() {
        ...
        assertThatThrownBy {
         ...
         .hasMessageContaining("The port of the path URL ('https://r3.com/') was not specified or had an invalid value.")
    }
    ...
    fun `context with URL without a host will throw an exception`() {
        ...
        assertThatThrownBy {
         ...
         .hasMessageContaining("The host of the path URL ('https://:4995/') was not specified or had an invalid value.")
    }
    ...
    fun `context with URL without https will throw an exception`() {
        ...
        assertThatThrownBy {
         ...
         .hasMessageContaining("The scheme of the path URL ('http://www.corda.net:8888') was not https.")
    }
