...
class VirtualNodeDbChangeLogTest {
    private val masterFile1 = CpkDbChangeLog(VirtualNodeDbChangeLog.MASTER_CHANGE_LOG, "migration1", SecureHash("SHA1", "abc".toByteArray()))
    private val otherFile1 = CpkDbChangeLog("another-one.xml", "migration2", SecureHash("SHA1", "abc".toByteArray()))
    private val masterFile2 = CpkDbChangeLog(VirtualNodeDbChangeLog.MASTER_CHANGE_LOG, "migration3", SecureHash("SHA1", "abc".toByteArray()))
