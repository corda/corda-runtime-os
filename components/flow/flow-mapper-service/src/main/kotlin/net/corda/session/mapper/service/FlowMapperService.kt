            ...
            if (System.getenv("ENABLE_MAPPER_PROCESS")!!.equals("TRUE", true)) {
                ...
                coordinator.createManagedResource(SUBSCRIPTION) {
                    subscriptionFactory.createPriorityStreamSubscription(
                        ...
                        mapOf(
                            Pair(1, listOf(FLOW_MAPPER_SESSION_IN_EVENT_TOPIC, FLOW_MAPPER_SESSION_OUT_EVENT_TOPIC, FLOW_MAPPER_START_EVENT_TOPIC)),
//                            Pair(2, listOf(FLOW_MAPPER_SESSION_OUT_EVENT_TOPIC)),
//                            Pair(3, listOf(FLOW_MAPPER_EVENT_TOPIC)),
//                            Pair(4, listOf(FLOW_MAPPER_SESSION_OUT_EVENT_TOPIC, FLOW_MAPPER_START_EVENT_TOPIC)),
                        ),
