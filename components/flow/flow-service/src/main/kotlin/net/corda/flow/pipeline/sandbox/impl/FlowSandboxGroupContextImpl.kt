...
class FlowSandboxGroupContextImpl(
    override val dependencyInjector: SandboxFlowDependencyInjector,
    ...
    companion object {
        ...
        fun fromContext(sandboxGroupContext: SandboxGroupContext): FlowSandboxGroupContext {
            val dependencyInjector = sandboxGroupContext.getObjectByKey<SandboxFlowDependencyInjector>(DEPENDENCY_INJECTOR)
