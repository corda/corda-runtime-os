...
object SerializationDefaults {
    object Config {
        var rpcServerContext: () -> SerializationContext = { throw CordaRuntimeException("SerializationDefault " +
                "accessed before being set by node startup") }
        var rpcClientContext: () -> SerializationContext = { throw CordaRuntimeException("SerializationDefault " +
                "accessed before being set by node startup") }
        var storageContext: () -> SerializationContext = { throw CordaRuntimeException("SerializationDefault " +
                "accessed before being set by node startup") }
        var p2pContext: () -> SerializationContext = { throw CordaRuntimeException("SerializationDefault " +
                "accessed before being set by node startup") }
        var serializationFactory: () -> SerializationFactory = { throw CordaRuntimeException("SerializationDefault " +
                "accessed before being set by node startup") }
    }
