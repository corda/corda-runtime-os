...
class MGMClientImpl @Activate constructor(
    ...
    private interface InnerMGMOpsClient : AutoCloseable {
        fun getGroupPolicy(holdingIdentityId: String): RegistrationRequestProgressDto
    }
    ...
    private inner class ActiveImpl(
        ...
        override fun getGroupPolicy(holdingIdentityId: String): RegistrationRequestProgressDto {
