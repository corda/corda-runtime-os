...
class FlowEngineImplTest {
    ...
    private val errorSessionState =
        SessionState("s", false, mock(), mock(), null, false, null, null, SessionStateType.ERROR, false, null)
    private val closedSessionState =
        SessionState("s", false, mock(), mock(), null, false, null, null, SessionStateType.CLOSED, false, null)
