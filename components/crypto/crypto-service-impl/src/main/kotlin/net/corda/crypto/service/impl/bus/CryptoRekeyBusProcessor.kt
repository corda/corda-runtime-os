    ...
    private fun processEvent(
        ...
        when (request.managedKey) {
            KeyType.UNMANAGED -> {
                ...
                // choice of cluster level tenant. We pick CryptoTenants.P2P as the arbitrary cluster level tenant,
                // and we should not also check other cluster level tenants since if we do we'll get duplicate.
                val allTenantIds = virtualNodeTenantIds + listOf(CryptoTenants.P2P)
