...
public class RPCFlowStart extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 636391963534707074L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RPCFlowStart\",\"namespace\":\"net.corda.client.rpc.flow\",\"fields\":[{\"name\":\"clientId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"userName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"nodeIdentity\",\"type\":{\"type\":\"record\",\"name\":\"SecureHash\",\"namespace\":\"net.corda.crypto\",\"fields\":[{\"name\":\"algorithm\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"serverHash\",\"type\":\"bytes\"}]}},{\"name\":\"flowName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"args\",\"type\":{\"type\":\"array\",\"items\":\"bytes\"}}]}");
  ...
  @Deprecated public net.corda.crypto.SecureHash nodeIdentity;
  @Deprecated public java.lang.String flowName;
  @Deprecated public java.util.List<java.nio.ByteBuffer> args;
   ...
   */
  public RPCFlowStart(java.lang.String clientId, java.lang.String userName, net.corda.crypto.SecureHash nodeIdentity, java.lang.String flowName, java.util.List<java.nio.ByteBuffer> args) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: nodeIdentity = (net.corda.crypto.SecureHash)value$; break;
   ...
   */
  public net.corda.crypto.SecureHash getNodeIdentity() {
    return nodeIdentity;
  }
   ...
   * @param value the value to set.
   */
  public void setNodeIdentity(net.corda.crypto.SecureHash value) {
   ...
   */
  public static net.corda.client.rpc.flow.RPCFlowStart.Builder newBuilder() {
    return new net.corda.client.rpc.flow.RPCFlowStart.Builder();
  }
   ...
   * @return A new RPCFlowStart RecordBuilder
   */
  public static net.corda.client.rpc.flow.RPCFlowStart.Builder newBuilder(net.corda.client.rpc.flow.RPCFlowStart.Builder other) {
    if (other == null) {
      return new net.corda.client.rpc.flow.RPCFlowStart.Builder();
    } else {
      return new net.corda.client.rpc.flow.RPCFlowStart.Builder(other);
    }
  }
   ...
   * @return A new RPCFlowStart RecordBuilder
   */
  public static net.corda.client.rpc.flow.RPCFlowStart.Builder newBuilder(net.corda.client.rpc.flow.RPCFlowStart other) {
    if (other == null) {
      return new net.corda.client.rpc.flow.RPCFlowStart.Builder();
    } else {
      return new net.corda.client.rpc.flow.RPCFlowStart.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RPCFlowStart>
    ...
    private net.corda.crypto.SecureHash nodeIdentity;
    private net.corda.crypto.SecureHash.Builder nodeIdentityBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.corda.client.rpc.flow.RPCFlowStart.Builder other) {
      super(other);
      ...
      if (other.hasNodeIdentityBuilder()) {
        this.nodeIdentityBuilder = net.corda.crypto.SecureHash.newBuilder(other.getNodeIdentityBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.corda.client.rpc.flow.RPCFlowStart other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.clientId)) {
        this.clientId = data().deepCopy(fields()[0].schema(), other.clientId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.client.rpc.flow.RPCFlowStart.Builder setClientId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.client.rpc.flow.RPCFlowStart.Builder clearClientId() {
      clientId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.client.rpc.flow.RPCFlowStart.Builder setUserName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.client.rpc.flow.RPCFlowStart.Builder clearUserName() {
      userName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.client.rpc.flow.RPCFlowStart.Builder setNodeIdentity(net.corda.crypto.SecureHash value) {
     ...
     * @return This builder.
     */
    public net.corda.crypto.SecureHash.Builder getNodeIdentityBuilder() {
      if (nodeIdentityBuilder == null) {
        if (hasNodeIdentity()) {
          setNodeIdentityBuilder(net.corda.crypto.SecureHash.newBuilder(nodeIdentity));
        } else {
          setNodeIdentityBuilder(net.corda.crypto.SecureHash.newBuilder());
        }
      }
    ...
    public net.corda.client.rpc.flow.RPCFlowStart.Builder setNodeIdentityBuilder(net.corda.crypto.SecureHash.Builder value) {
      clearNodeIdentity();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.client.rpc.flow.RPCFlowStart.Builder clearNodeIdentity() {
      nodeIdentity = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.client.rpc.flow.RPCFlowStart.Builder setFlowName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.client.rpc.flow.RPCFlowStart.Builder clearFlowName() {
      flowName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.client.rpc.flow.RPCFlowStart.Builder setArgs(java.util.List<java.nio.ByteBuffer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.client.rpc.flow.RPCFlowStart.Builder clearArgs() {
      args = null;
    ...
    public RPCFlowStart build() {
      try {
        ...
        if (nodeIdentityBuilder != null) {
          ...
          record.nodeIdentity = fieldSetFlags()[2] ? this.nodeIdentity : (net.corda.crypto.SecureHash) defaultValue(fields()[2]);
        }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.nodeIdentity == null) {
        this.nodeIdentity = new net.corda.crypto.SecureHash();
      }
