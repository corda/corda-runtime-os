...
interface FlowSessionManager {
     ...
     *
     * @param checkpoint The flow's [Checkpoint].
     ...
     */
    fun sendInitMessage(checkpoint: Checkpoint, sessionId: String, x500Name: MemberX500Name, instant: Instant): SessionState
     ...
     *
     * @throws FlowProcessingException If a session does not exist within the flow's [Checkpoint].
     */
    fun sendDataMessages(checkpoint: Checkpoint, sessionToPayload: Map<String, ByteArray>, instant: Instant): List<SessionState>
     ...
     * @throws FlowProcessingException If a session does not exist within the flow's [Checkpoint].
     */
    fun sendCloseMessages(checkpoint: Checkpoint, sessionIds: List<String>, instant: Instant): List<SessionState>
     ...
     * @throws FlowProcessingException If a session does not exist within the flow's [Checkpoint].
     */
    fun getReceivedEvents(checkpoint: Checkpoint, sessionIds: List<String>): List<Pair<SessionState, SessionEvent>>
     ...
     * @throws FlowProcessingException If a session does not exist within the flow's [Checkpoint].
     */
    fun hasReceivedEvents(checkpoint: Checkpoint, sessionIds: List<String>): Boolean
     ...
     * @throws FlowProcessingException If a session does not exist within the flow's [Checkpoint].
     */
    fun areAllSessionsInStatuses(checkpoint: Checkpoint, sessionIds: List<String>, statuses: List<SessionStateType>): Boolean
}