package net.corda.ledger.consensual.persistence.impl

import net.corda.configuration.read.ConfigChangedEvent
import net.corda.configuration.read.ConfigurationReadService
import net.corda.cpiinfo.read.CpiInfoReadService
import net.corda.ledger.consensual.persistence.ConsensualLedgerPersistenceService
...
@Component(service = [ConsensualLedgerPersistenceService::class])
class ConsensualLedgerPersistenceServiceImpl  @Activate constructor(
    ...
    private val coordinator = coordinatorFactory.createCoordinator<ConsensualLedgerPersistenceService>(dependentComponents, ::eventHandler)
