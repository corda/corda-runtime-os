  ...
  template:
    ...
    spec:
      ...
      initContainers:
        ...
        {{- include "corda.generateAndExecuteSql" ( dict "name" "vnodes-ddl" "longName" "virtual-nodes-ddl" "dbName" "virtualNodesDdl" "admin" "true" "Values" .Values "Chart" .Chart "Release" .Release "environmentVariablePrefix" "DB_CLUSTER" "sequenceNumber" 7) | nindent 8 }}
        {{- include "corda.generateAndExecuteSql" ( dict "name" "vnodes-dml" "longName" "virtual-nodes-dml" "dbName" "virtualNodesDml" "Values" .Values "Chart" .Chart "Release" .Release "environmentVariablePrefix" "DB_CLUSTER" "sequenceNumber" 9) | nindent 8 }}
        ...
        - name: 15-create-db-users-and-grant
