...
internal class VerificationRequestHandler(
    ...
    override fun invokeAuthenticatedMessage(
        ...
        val verificationRequest: VerificationRequest = avroSchemaRegistry.deserialize(payload)
        val key = header.destination.toCorda().shortHash + "-" + verificationRequest.registrationId
        return Record(
