...
class EventLogSubscriptionImplTest {
    ...
    fun setup() {
        ...
        doReturn(mockCordaProducer).whenever(cordaProducerBuilder).createProducer(any(), any(), anyOrNull())
    ...
    fun testFatalExceptionConsumerBuild() {
        ...
        verify(cordaProducerBuilder, times(0)).createProducer(any(), any(), anyOrNull())
    ...
    fun testIntermittentExceptionDuringProcessing() {
        whenever(cordaProducerBuilder.createProducer(any(), any(), any()))
            .thenReturn(mockCordaProducer)
            .thenThrow(CordaMessageAPIFatalException("Consumer Create Fatal Error", Exception()))
