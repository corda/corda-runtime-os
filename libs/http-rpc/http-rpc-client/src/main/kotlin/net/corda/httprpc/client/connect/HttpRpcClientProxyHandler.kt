...
internal class HttpRpcClientProxyHandler<I : RestResource>(
    ...
    override fun invoke(proxy: Any, method: Method, args: Array<out Any?>?): Any? {
        ...
        val resourcePath = rpcOpsClass.getAnnotation(HttpRestResource::class.java)?.path(rpcOpsClass)
            ?: throw UnsupportedOperationException(
                "Http RPC proxy can not make remote calls for interfaces not annotated with HttpRestResource."
            )
