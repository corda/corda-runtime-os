...
class ConsensualLedgerMessageProcessorTests {
    ...
    private lateinit var messageHandlerSelector: MessageHandlerSelector
    ...
    fun setup(
        ...
        lifecycle.accept(sandboxSetup) { setup ->
            ...
            messageHandlerSelector = setup.fetchService(timeout = 10000)
    ...
    fun `persistTransaction for consensual ledger deserialises the transaction and persists`() {
        ...
        val findRequest =
            createRequest(ctx.virtualNodeInfo.holdingIdentity, FindTransaction(transaction.id.toHexString()))
        responses =
