...
class TransferFlow: ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        ...
        try {
            ...
            val ownerInfo = memberLookup.lookup(inputState.owner.name) ?:
            ...
            val outputState = inputState.withNewOwner(Member(newOwnerInfo.name, newOwnerInfo.ledgerKeys[0]),
            ...
            return jsonMarshallingService.format(TransferFlowResult(transactionId, outputState.assetId))
