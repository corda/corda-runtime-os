...
@CordaSystemFlow
class ConsensualReceiveFinalityFlowV1(
    private val session: FlowSession,
    private val validator: ConsensualTransactionValidator
) : ConsensualFinalityBaseV1() {

    private companion object {
        val log: Logger = LoggerFactory.getLogger(ConsensualReceiveFinalityFlowV1::class.java)
    }

    override val log: Logger = ConsensualReceiveFinalityFlowV1.log
