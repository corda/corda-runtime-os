 ...
 */
@Component(service = [CpiInfoWriterComponent::class])
class CpiInfoWriterComponentImpl @Activate constructor(
    ...
    private val coordinator = coordinatorFactory.createCoordinator<CpiInfoWriterComponent>(eventHandler)
