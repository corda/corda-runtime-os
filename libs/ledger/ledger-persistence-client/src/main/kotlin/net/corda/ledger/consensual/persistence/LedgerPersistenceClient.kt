...
/**
 * [LedgerPersistenceClient] allows to insert and find consensual signed transactions in the persistent store provided
 * by the platform.
 */
interface LedgerPersistenceClient {
    /**
     ...
     */
    fun persist(transaction: ConsensualSignedTransactionImpl)
     ...
     */
    fun find(id: SecureHash): ConsensualSignedTransactionImpl?
}
