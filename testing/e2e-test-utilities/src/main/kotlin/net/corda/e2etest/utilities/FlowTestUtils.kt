...
val RPC_VALID_STATUSES = listOf(
    RPC_FLOW_STATUS_SUCCESS,
    RPC_FLOW_STATUS_FAILED,
    RPC_FLOW_STATUS_KILLED,
    RPC_FLOW_STATUS_RETRYING,
    RPC_FLOW_STATUS_RUNNING,
    RPC_FLOW_STATUS_START_REQUESTED
)
