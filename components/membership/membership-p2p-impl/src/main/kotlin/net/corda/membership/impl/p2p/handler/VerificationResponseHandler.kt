...
internal class VerificationResponseHandler(
    ...
    override fun invokeAuthenticatedMessage(
        ...
        val verificationResponse: VerificationResponse = avroSchemaRegistry.deserialize(payload)
        val key = header.destination.toCorda().shortHash + "-" + verificationResponse.registrationId
        return Record(
