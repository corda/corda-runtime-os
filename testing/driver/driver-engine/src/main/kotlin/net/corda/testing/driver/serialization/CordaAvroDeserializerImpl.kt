...
class CordaAvroDeserializerImpl<T : Any>(
    ...
    private companion object {
        ...
        private const val errorMsg = "Failed to deserialized bytes returned"
    }

    private fun deserialize(data: ByteArray, allowChunks: Boolean): Any? {
    ...
    private fun deserializeAvro(data: ByteArray, allowChunks: Boolean) : Any? = try {
        ...
        // many records) would fail, and keep failing.  So we'll just call back to note the bad deserialize
