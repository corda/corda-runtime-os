 ...
 * @param useClusterLevelCertificateAndKey Should the P2P cluster level certificate type and  P2P key will be used or
...
data class HostedIdentitySetupRequest(
    ...
    val useClusterLevelCertificateAndKey: Boolean?,
