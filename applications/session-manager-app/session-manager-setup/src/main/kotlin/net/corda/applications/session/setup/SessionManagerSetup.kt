...
import net.corda.applications.session.setup.helper.getHelloWorldRPCEventRecord
...
@Component
class SessionManagerSetup @Activate constructor(
    ...
    override fun startup(args: Array<String>) {
        consoleLogger.info("Starting session manager setup tool...")
        ...
        lifeCycleCoordinator =
            coordinatorFactory.createCoordinator<SessionManagerSetup> { event: LifecycleEvent, coordinator: LifecycleCoordinator ->
    ...
    override fun shutdown() {
        consoleLogger.info("Stopping Flow Session Manager setup tool")
        log.info("Stopping Flow Session setup tool")
