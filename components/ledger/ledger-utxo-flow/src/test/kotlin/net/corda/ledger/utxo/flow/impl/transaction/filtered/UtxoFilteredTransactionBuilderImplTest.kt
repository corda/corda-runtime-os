...
class UtxoFilteredTransactionBuilderImplTest {
    ...
    fun withSignatoriesSize() {
        ...
        assertThat(componentGroupFilterParameters).isInstanceOf(
            SizeProof::class.java)
    ...
    fun withSignatories() {
        ...
        assertThat(componentGroupFilterParameters).isInstanceOf(
            AuditProof::class.java)
        assertThat((componentGroupFilterParameters!!).componentGroupIndex).isEqualTo(UtxoComponentGroup.SIGNATORIES.ordinal)
        assertThat(((componentGroupFilterParameters as AuditProof<PublicKey>).predicate as Predicate<PublicKey>).test(mock()))
            .isEqualTo(true)
    }
    ...
    fun `withSignatories predicate`() {
        ...
        assertThat(componentGroupFilterParameters).isInstanceOf(
            AuditProof::class.java)
        assertThat((componentGroupFilterParameters!!).componentGroupIndex).isEqualTo(UtxoComponentGroup.SIGNATORIES.ordinal)
        assertThat(((componentGroupFilterParameters as
                AuditProof<PublicKey>).predicate as Predicate<PublicKey>).test(mock()))
            .isEqualTo(false)
    }
    ...
    fun withInputStates() {
        ...
        assertThat((componentGroupFilterParameters!!).componentGroupIndex).isEqualTo(UtxoComponentGroup.INPUTS.ordinal)
        assertThat(((componentGroupFilterParameters as
                AuditProof<StateRef>).predicate as Predicate<PublicKey>).test(mock()))
            .isEqualTo(true)
    }
    ...
    fun withOutputStates() {
        ...
        assertThat((componentGroupFilterParameters!!).componentGroupIndex).isEqualTo(UtxoComponentGroup.OUTPUTS.ordinal)
        assertThat(((componentGroupFilterParameters as
                AuditProof<ContractState>).predicate as Predicate<PublicKey>).test(mock()))
            .isEqualTo(true)
    }
    ...
    fun withCommands() {
        ...
        assertThat((componentGroupFilterParameters!!).componentGroupIndex).isEqualTo(UtxoComponentGroup.COMMANDS.ordinal)
        assertThat(((componentGroupFilterParameters as
                AuditProof<Command>).predicate as Predicate<PublicKey>).test(mock()))
            .isEqualTo(true)
    }
    ...
    fun `set all`() {
        ...
        assertThat(builder.signatories).isInstanceOf(
            SizeProof::class.java)
        assertThat(builder.inputStates).isInstanceOf(
            AuditProof::class.java)
        assertThat(builder.referenceStates).isInstanceOf(
            SizeProof::class.java)
        assertThat(builder.outputStates).isInstanceOf(
            SizeProof::class.java)
        assertThat(builder.commands).isInstanceOf(
            AuditProof::class.java)
    }
