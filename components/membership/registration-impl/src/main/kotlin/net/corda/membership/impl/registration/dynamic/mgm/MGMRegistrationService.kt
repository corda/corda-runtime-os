    ...
    private inner class ActiveImpl : InnerRegistrationService {
        ...
        override fun register(
            ...
            return try {
                ...
                val (mgmInfo, records) = mgmRegistrationMemberInfoHandler.buildAndPersist(
                    registrationId,
                    member,
                    context
                )
                ...
                val groupParametersRecords = groupParametersWriterService.createRecords(member, groupParameters)

                mgmRegistrationOutputPublisher.publish(mgmInfo) + records + groupParametersRecords
