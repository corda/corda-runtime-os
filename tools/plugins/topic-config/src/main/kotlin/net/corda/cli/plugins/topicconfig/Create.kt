...
class Create(
    ...
    private val workersForProcessor = mapOf(
        ...
        "flow_start" to listOf("flow_start", "combined"),
        "flow_session" to listOf("flow_session", "combined"),
        "flow_crypto" to listOf("flow_crypto", "combined"),
        "flow_db" to listOf("flow_db", "combined"),
        "flow_uniqueness" to listOf("flow_uniqueness", "combined"),
        "flow_verification" to listOf("flow_verification", "combined"),
        "flow_ledger" to listOf("flow_ledger", "combined"),
