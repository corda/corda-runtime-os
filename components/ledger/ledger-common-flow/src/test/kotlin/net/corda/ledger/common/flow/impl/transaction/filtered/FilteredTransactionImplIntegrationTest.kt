    ...
    fun `transaction can be filtered and successfully verified`() {
        ...
        filteredTransaction = filteredTransactionFactory.create(
            ...
            componentGroupFilterParameters = listOf(
                ...
                ComponentGroupFilterParameters.AuditProof(2, Any::class.java, AuditProofPredicate.Content { it is MyClassC }),
                ComponentGroupFilterParameters.AuditProof(3, Any::class.java, AuditProofPredicate.Content { it is MyClassC }),
                ComponentGroupFilterParameters.SizeProof(4),
                ComponentGroupFilterParameters.AuditProof(5, Any::class.java, AuditProofPredicate.Content { it is MyClassC }),
                ComponentGroupFilterParameters.AuditProof(6, Any::class.java, AuditProofPredicate.Content { it is MyClassC }),
