...
class KafkaSigningKeysPersistenceProcessor(
    subscriptionFactory: SubscriptionFactory,
    publisherFactory: PublisherFactory
) : CompactedProcessor<String, SigningKeysRecord>, KafkaPersistenceProcessor<SigningKeysRecord> {
    companion object {
    ...
    override fun getValue(tenantId: String, key: String): SigningKeysRecord? {
