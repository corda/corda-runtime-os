...
class SessionEventHandler @Activate constructor(
    ...
    private fun createInitiatedFlowCheckpoint(
        ...
        val initiatingToInitiatedFlows =
            getInitiatingToInitiatedFlowsFromSandbox(initiatingIdentity.toCorda())
        val initiatedFlow =
            initiatingToInitiatedFlows[sessionInit.cpiId to sessionInit.flowName] ?: throw FlowProcessingException(
    ...
    private fun getInitiatingToInitiatedFlowsFromSandbox(holdingIdentity: HoldingIdentity): Map<Pair<String, String>, String> {
        return flowSandboxService.get(holdingIdentity)
            .getObjectByKey(FlowSandboxContextTypes.INITIATING_TO_INITIATED_FLOWS)
