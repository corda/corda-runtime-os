...
/**
 * This class can be used as a return type in [RestResource] endpoints to allow control over the status code returned in the HTTP responses.
 *
 ...
 *
 * If an [RestResource] endpoint function doesn't wrap its return type in a [ResponseEntity], it will set the response's status code to
 * [ResponseCode.OK] (200) unless an exception is thrown.
 *
 * If an [RestResource] endpoint has no return type at all, it will return a response with no body and a status code of [ResponseCode.NO_CONTENT]
