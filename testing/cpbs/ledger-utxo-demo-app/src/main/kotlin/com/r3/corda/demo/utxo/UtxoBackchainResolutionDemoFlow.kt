...
//    lateinit var memberLookup: MemberLookup
    ...
    override fun call(requestBody: ClientRequestBody): String {
        log.info("Filipe")
        //val bankX500 = MemberX500Name.parse("CN=Charlie-1, OU=Application, O=R3, L=London, C=GB")
...
// Create our selection criteria to select a minimum of 100 GBP worth of coins
        val selectionCriteria = TokenClaimCriteria(
            CoinState.tokenType,
            digestService.hash("CN=Charlie-1, OU=Application, O=R3, L=London, C=GB".toByteArray(), DigestAlgorithmName.SHA2_256),
            notary.name,
            "USD",
            BigDecimal(10)
        )
        ...
        log.info("Filipe - Done ${tokenClaim?.claimedTokens?.size}")
