package net.corda.messaging.impl.topic.service
...
interface TopicService {
    ...
    /**
     * Unsubscribe from a [topicName] for the given [consumerGroup]
     * Deletes the consumers offset history from the topic.
     */
