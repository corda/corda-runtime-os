...
public class FlowMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1911862083499840413L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"FlowMessage\",\"namespace\":\"net.corda.p2p.crypto\",\"fields\":[{\"name\":\"header\",\"type\":{\"type\":\"record\",\"name\":\"FlowMessageHeader\",\"fields\":[{\"name\":\"destination\",\"type\":{\"type\":\"record\",\"name\":\"AvroHoldingIdentity\",\"fields\":[{\"name\":\"x500Name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"groupId\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}]}]}},{\"name\":\"source\",\"type\":\"AvroHoldingIdentity\"},{\"name\":\"ttl\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"messageId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"traceId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}},{\"name\":\"payload\",\"type\":\"bytes\"}]}");
  ...
  public static FlowMessage fromByteBuffer(
   ...
   private net.corda.p2p.crypto.FlowMessageHeader header;
   ...
   */
  public FlowMessage(net.corda.p2p.crypto.FlowMessageHeader header, java.nio.ByteBuffer payload) {
    this.header = header;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: header = (net.corda.p2p.crypto.FlowMessageHeader)value$; break;
   ...
   */
  public net.corda.p2p.crypto.FlowMessageHeader getHeader() {
    return header;
  }
   ...
   */
  public void setHeader(net.corda.p2p.crypto.FlowMessageHeader value) {
    this.header = value;
  }
   ...
   */
  public static net.corda.p2p.crypto.FlowMessage.Builder newBuilder() {
    return new net.corda.p2p.crypto.FlowMessage.Builder();
  }
   ...
   * @return A new FlowMessage RecordBuilder
   */
  public static net.corda.p2p.crypto.FlowMessage.Builder newBuilder(net.corda.p2p.crypto.FlowMessage.Builder other) {
    if (other == null) {
      return new net.corda.p2p.crypto.FlowMessage.Builder();
    } else {
      return new net.corda.p2p.crypto.FlowMessage.Builder(other);
    }
  }
   ...
   * @return A new FlowMessage RecordBuilder
   */
  public static net.corda.p2p.crypto.FlowMessage.Builder newBuilder(net.corda.p2p.crypto.FlowMessage other) {
    if (other == null) {
      return new net.corda.p2p.crypto.FlowMessage.Builder();
    } else {
      return new net.corda.p2p.crypto.FlowMessage.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FlowMessage>
    ...
    private net.corda.p2p.crypto.FlowMessageHeader header;
    private net.corda.p2p.crypto.FlowMessageHeader.Builder headerBuilder;
    private java.nio.ByteBuffer payload;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.corda.p2p.crypto.FlowMessage.Builder other) {
      super(other);
      ...
      if (other.hasHeaderBuilder()) {
        this.headerBuilder = net.corda.p2p.crypto.FlowMessageHeader.newBuilder(other.getHeaderBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.corda.p2p.crypto.FlowMessage other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.header)) {
        this.header = data().deepCopy(fields()[0].schema(), other.header);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.p2p.crypto.FlowMessage.Builder setHeader(net.corda.p2p.crypto.FlowMessageHeader value) {
     ...
     * @return This builder.
     */
    public net.corda.p2p.crypto.FlowMessageHeader.Builder getHeaderBuilder() {
      if (headerBuilder == null) {
        if (hasHeader()) {
          setHeaderBuilder(net.corda.p2p.crypto.FlowMessageHeader.newBuilder(header));
        } else {
          setHeaderBuilder(net.corda.p2p.crypto.FlowMessageHeader.newBuilder());
        }
      }
    ...
    public net.corda.p2p.crypto.FlowMessage.Builder setHeaderBuilder(net.corda.p2p.crypto.FlowMessageHeader.Builder value) {
      clearHeader();
      headerBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.p2p.crypto.FlowMessage.Builder clearHeader() {
      header = null;
      headerBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.p2p.crypto.FlowMessage.Builder setPayload(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.corda.p2p.crypto.FlowMessage.Builder clearPayload() {
      payload = null;
    ...
    public FlowMessage build() {
      try {
        ...
        if (headerBuilder != null) {
          ...
          record.header = fieldSetFlags()[0] ? this.header : (net.corda.p2p.crypto.FlowMessageHeader) defaultValue(fields()[0]);
        }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (this.header == null) {
        this.header = new net.corda.p2p.crypto.FlowMessageHeader();
      }
