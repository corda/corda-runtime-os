...
class BasicHashingServiceTests {
    ...
    fun `Should calculate sha2-384 secure hash`() {
        ...
        assertEquals(digestService.create(
    ...
    fun `Should calculate sha3-384 secure hash`() {
        ...
        assertEquals(digestService.create("SHA3-384:AB698010362BFEDB89BCC8800F7E1410A92D83D5B80B99969A079D1FF1BC0" +
    ...
    fun `Should calculate sha3-512 secure hash`() {
        ...
        assertEquals(digestService.create("SHA3-512:20FDD4FAB7B85E6C9227C679588E1E62A781217C455AEC5792DA155736C2" +
