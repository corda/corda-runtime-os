...
class JsonSerialisationSpec {
    ...
    fun assertRoundtripsCorrectly(request: FacadeRequest) {
        ...
        assertEquals(request, deserialised)
    }
    ...
    fun assertRoundtripsCorrectly(response: FacadeResponse) {
        ...
        assertEquals(response, deserialised)
    }
    ...
    @Test
    fun `serialises bytes to a base64 encoded string`() {
    ...
    @Test
    fun `serialises json to embedded json`() {
    ...
    @Test
    fun `serialises a timestamp to a formatted string`() {
