...
public final class MurmurHash3 {
    ...
    public static int hash32(long value) {
        return (int) fmix64(value);
    }

    public static int hash32(float value) {
        return fmix32(Float.floatToRawIntBits(value));
    }

    public static int hash32(double value) {
        return (int) fmix64(Double.doubleToRawLongBits(value));
    }
