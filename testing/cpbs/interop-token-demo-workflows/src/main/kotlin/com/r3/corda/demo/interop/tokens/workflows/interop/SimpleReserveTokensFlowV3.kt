...
class SimpleReserveTokensFlowV3 : ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        log.info("SimpleReserveTokensFlow.call() starting test v3")
        ...
        val responseObject: InteropAction<SimpleTokenReservation> = client.reserveTokensV3(
            "USD", BigDecimal(100), 100)
