...
enum class SectionId : OrdinalBits.OrdinalWriter {
...
enum class CordaSerializationEncoding(private val encoderType: EncoderType) : SerializationEncoding, OrdinalBits.OrdinalWriter {
